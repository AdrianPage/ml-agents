...
namespace Unity.MLAgentsExamples
{
    ...
    public class ModelOverrider : MonoBehaviour
    {
        ...
        {
           get { return m_PreviousAgentCompletedEpisodes + getStepsFromAgent(); }
        }

        int getStepsFromAgent()
        {
            int steps = 0;
            if (m_Agent != null)
            {
                steps = m_Agent.CompletedEpisodes;
            }

            if (mo_Agent != null)
            {
                steps = mo_Agent.CompletedEpisodes;
            }
            return steps;
        }
        ...
        public string OriginalBehaviorName
        {
            get
            {
                ...
                {
                    var bpS = m_Agent.GetComponent<BehaviorParameters>();
                    var bpM = mo_Agent.GetComponent<BehaviorParameters>();
                    
                    if (bpS != null)
                    {
                        m_OriginalBehaviorName = bpS.BehaviorName;
                    }
                    else 
                    {
                        m_OriginalBehaviorName = bpM.BehaviorName;
                    }
        ...
        void FixedUpdate()
        {
            if (m_MaxEpisodes > 0)
            {
                ...
                if (m_Agent != null)
                {
                    maxSteps = m_Agent.MaxStep;
                }

                if (mo_Agent != null)
                {
                    maxSteps = mo_Agent.MaxStep;
                }

                if (TotalCompletedEpisodes >= m_MaxEpisodes && TotalNumSteps > m_MaxEpisodes * maxSteps)
                {
        ...
        void OverrideModel()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (mo_Agent != null)
                    {
                        mo_Agent.SetModel(GetOverrideBehaviorName(OriginalBehaviorName), nnModel);
                    }
