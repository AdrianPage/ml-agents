...
from mlagents.trainers.mppo.optimizer_torch import TorchPPOOptimizer
from mlagents.trainers.trajectory import Trajectory
from mlagents.trainers.behavior_id_utils import BehaviorIdentifiers
from mlagents.trainers.settings import TrainerSettings, MPPOSettings
from mlagents.trainers.vector2scalar import vectorutil

logger = get_logger(__name__)


class MPPOTrainer(RLTrainer):
    ...
    def __init__(
        ...
        self.hyperparameters: MPPOSettings = cast(
            MPPOSettings, self.trainer_settings.hyperparameters
        )
        self.seed = seed
    ...
    def _process_trajectory(self, trajectory: Trajectory) -> None:
        ...
        for name in self.optimizer.reward_signals:
            ...
            # Vector to Scalar utility to allow multi-objective
            rew = vectorutil.vector2scalar(local_rewards)
